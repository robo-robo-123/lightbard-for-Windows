...
namespace ModernUITwitterApp.Translator {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private ModernUITwitterApp.Translator.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public ModernUITwitterApp.Translator.TranslationMatch[] Translations {
            get {
    ...
    public interface LanguageService {
        ...
        ModernUITwitterApp.Translator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, ModernUITwitterApp.Translator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, ModernUITwitterApp.Translator.Translation[] translations, string from, string to, ModernUITwitterApp.Translator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        ModernUITwitterApp.Translator.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, ModernUITwitterApp.Translator.TranslateOptions options);
        ...
        ModernUITwitterApp.Translator.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, ModernUITwitterApp.Translator.TranslateOptions options);
        ...
        ModernUITwitterApp.Translator.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, ModernUITwitterApp.Translator.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : ModernUITwitterApp.Translator.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<ModernUITwitterApp.Translator.LanguageService>, ModernUITwitterApp.Translator.LanguageService {
        ...
        public ModernUITwitterApp.Translator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, ModernUITwitterApp.Translator.TranslateOptions options) {
        ...
        public ModernUITwitterApp.Translator.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, ModernUITwitterApp.Translator.TranslateOptions options) {
